 ...
 * Base client class
 */
if (!class_exists('Base_Services_Twilio')) {
 ...
 *      // Take some action with the client, etc.
 */
if (!class_exists('TaskRouter_Services_Twilio')) {
 ...
 *      // Take some action with the client, etc.
 */
if (!class_exists('Lookups_Services_Twilio')) {
 ...
 *      // Take some action with the client, etc.
 */
if (!class_exists('Pricing_Services_Twilio')) {
 ...
 *      // Take some action with the client, etc.
 */
if (!class_exists('Monitor_Services_Twilio')) {
 ...
 *      // Take some action with the client, etc.
 */
if (!class_exists('Trunking_Services_Twilio')) {
 ...
 *      // Take some action with the client, etc.
 */
if (!class_exists('IPMessaging_Services_Twilio')) {
